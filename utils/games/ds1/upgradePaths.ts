...
// Export upgrade paths in the new format
export const upgradePaths = {
  ...
  crystal: {
    maxLevel: 5,
    materials: ["titanite_chunk", "titanite_slab"],
    costs: [200, 200, 200, 200, 200],
  },
  raw: {
    maxLevel: 5,
    materials: ["titanite_shard"],
    costs: [200, 200, 200, 200, 200],
  },
  lightning: {
    maxLevel: 5,
  ...
  magic: {
    ...
    costs: [200, 200, 200, 200, 200, 200, 200, 200, 200, 200],
  },
  enchanted: {
    maxLevel: 5,
    materials: ["blue_titanite_chunk", "blue_titanite_slab"],
    costs: [200, 200, 200, 200, 200],
  },
  divine: {
    maxLevel: 10,
  ...
  occult: {
    maxLevel: 5,
    materials: ["white_titanite_chunk", "white_titanite_slab"],
    costs: [200, 200, 200, 200, 200],
  },
  chaos: {
    maxLevel: 5,
    materials: ["red_titanite_chunk", "red_titanite_slab"],
    costs: [200, 200, 200, 200, 200],
  },
  boss: {
    maxLevel: 5,
    materials: ["demon_titanite"],
    costs: [5000, 5000, 5000, 5000, 5000],
  },
  special: {
    maxLevel: 5,
    materials: ["twinkling_titanite"],
    costs: [200, 200, 200, 200, 200],
  },
  dragon: {
    maxLevel: 5,
